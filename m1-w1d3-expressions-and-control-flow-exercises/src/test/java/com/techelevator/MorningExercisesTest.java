 ...
 */
public class MorningExercisesTest {

    private MorningExercises exercises = new MorningExercises();
    ...
    @Test
    public void testReturnFiveUsingPlusPlus() {
        assertEquals(5, exercises.returnFiveUsingPlusPlus());
    }

    @Test
    public void testReturnFourUsingPlusPlus() {
        assertEquals(4, exercises.returnFourUsingPlusPlus());
    }
    ...
    @Test
    public void testReturnAdultOrMinorReversed() {
        assertEquals("Adult", exercises.returnAdultOrMinorReversed(20));
        assertEquals("Adult", exercises.returnAdultOrMinorReversed(18));
        assertEquals("Minor", exercises.returnAdultOrMinorReversed(17));
    }
}